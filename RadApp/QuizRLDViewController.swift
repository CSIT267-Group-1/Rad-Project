...
class QuizRLDViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    func createQuestions()
    {
        ...
        questions.append(Quiz(question: "What is the flexure that is well visualized for a RPO (right posterior oblique) view for a barium enema?", hasMultipleChoice: false, correctButton: spleFlex, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "In the RAO (right anterior oblique) of a, barium enema view which flexure is of interest?", hasMultipleChoice: false, correctButton: hepFelx, buttonArray: nil, bariumQuestion: false))
        
        questions.append(Quiz(question: "What is the location of the transverse colon on an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: tranCol, buttonArray: nil, bariumQuestion: false))
        
        questions.append(Quiz(question: "What is the location of the sigmoid colon on an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: sigmoid, buttonArray: nil, bariumQuestion: false))
        
        questions.append(Quiz(question: "What is the location of the ascending colon on an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: ascCol, buttonArray: nil, bariumQuestion: false))
        
        questions.append(Quiz(question: "What is the location of the descending colon on an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: descCol, buttonArray: nil, bariumQuestion: false))
        
        questions.append(Quiz(question: "What is the location of the hepatic flexure on an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: hepFelx, buttonArray: nil, bariumQuestion: false))
        
        questions.append(Quiz(question: "What is the location of the splenic flexure on an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: spleFlex, buttonArray: nil, bariumQuestion: false))
        
        questions.append(Quiz(question: "What is the location of the barium in the ascending colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: bariumAscCol, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "What is the location of the air in the ascending colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: airAscCol, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "What is the location of the barium in the descending colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: bariumDescCol, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "What is the location of the air in the descending colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: airDescCol, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "What is the location of the barium in the ssigmoid colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: bariumSigmoid, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "What is the location of the air in the ssigmoid colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: airSigmoid, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "What is the location of the barium in the transverse colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: bariumTranCol, buttonArray: nil, bariumQuestion: true))
        
        questions.append(Quiz(question: "What is the location of the air in the transverse colon in an RLD view of a barium enema?", hasMultipleChoice: false, correctButton: airTranCol, buttonArray: nil, bariumQuestion: true))
        
        multipleChoiceArray = ["Left colic flexure and the descending colon", "Right colic flexure and the ascending and sigmoid colon are seen open", "Right colic flexure and the ascending and sigmoid colon are seen closed", "Left colic flexure and the ascending colon are only seen closed"]
        questions.append(Quiz(question: "What anatomy needs to be included in the RAO (right anterior oblique) view of a barium enema?", hasMultipleChoice: true, correctButton: multipleChoiceButtonB, buttonArray: multipleChoiceArray, bariumQuestion: true))
        
        multipleChoiceArray = ["Entire large intestine is included along with the rectal ampulla", "Entire large intestine is included along with the valve of rectal", "Entire small intestine is included", "Entire small intestine is included along with the liver"]
        questions.append(Quiz(question: "In the RAO (right anterior oblique) of a barium enema view what needs to be included in the view?", hasMultipleChoice: true, correctButton: multipleChoiceButtonA, buttonArray: multipleChoiceArray, bariumQuestion: false))
        ...
        multipleChoiceArray = ["Air-filled left hepatic flexure and descending colon", "Air-filled left hepatic flexure and ascending colon", "Air-filled right splenic flexure and descending colon", "Air-filled left hepatic flexure and ascending colon."]
        questions.append(Quiz(question: "In the right lateral decubitus position for a barium enema view, what is the air/barium relationship?", hasMultipleChoice: true, correctButton: multipleChoiceButtonA, buttonArray: multipleChoiceArray, bariumQuestion: false))
        
        multipleChoiceArray = ["The left side", "The right side", "The transverse side", "The back side"]
        questions.append(Quiz(question: "In the right lateral decubitus position for a barium enema view, what is demonstrated best?", hasMultipleChoice: true, correctButton: multipleChoiceButtonA, buttonArray: multipleChoiceArray, bariumQuestion: false))
